...
For the latest changes please see the [Release Notes](https://github.com/Semantic-Org/UI-Progress/blob/master/RELEASE-NOTES.md)
...
```
meteor add semantic:ui-progress
```
